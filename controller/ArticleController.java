...
public class ArticleController {
    ...
    public String createArticle(ArticleForm form) { //폼 데이터를 DTO로 받기
        ...
        // 1. DTO를 엔티티로 변환(toEntity)
        Article article = form.toEntity();  //Article 클래스 = 엔티티 클래스
    ...
    @GetMapping("/articles/{id}")   // 단일 데이터 조회 요청 접수
    ...
    public String update(ArticleForm articleForm) { //매개변수로 DTO 받아 오기
